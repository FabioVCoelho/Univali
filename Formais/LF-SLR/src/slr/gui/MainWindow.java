...
public class MainWindow extends JFrame {
	...
	public MainWindow(final UIController uiController) {
		...
		MainWindow.this.btnUnion.setEnabled(false);
		MainWindow.this.btnDifference.setEnabled(false);
	}
	...
	private void initComponents() {
        ...
        btnUnion.setText("União");
        
        btnDifference.setText("Diferença");
        ...
        panelAutomataOperationsLayout.setHorizontalGroup(
            ...
            .addGroup(panelAutomataOperationsLayout.createSequentialGroup()
                ...
                .addGroup(panelAutomataOperationsLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnUnion, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
	...
	private void setActionCommands() {
		...
		this.btnUnion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				List<String> labels = MainWindow.this.listFiniteAutomata.getSelectedValuesList();
				MainWindow.this.uiController.unionFiniteAutomata(labels.get(0), labels.get(1));
			}
		});
		
		this.btnDifference.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				List<String> labels = MainWindow.this.listFiniteAutomata.getSelectedValuesList();
				MainWindow.this.uiController.differenceFiniteAutomata(labels.get(0), labels.get(1));
			}
		});
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				switch (items) {
					...
					case 2:
						...
						MainWindow.this.btnUnion.setEnabled(true);
						MainWindow.this.btnDifference.setEnabled(true);
						break;
					default:
