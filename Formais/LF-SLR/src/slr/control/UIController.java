...
public class UIController {
	...
	public void unionFiniteAutomata(String automatonLabel1, String automatonLabel2) {
		this.mainController.unionFiniteAutomata(automatonLabel1, automatonLabel2);
	}
	
	/**
	 * Diferença entre dois autômatos.
	 * @param automatonLabel1 nome do autômato 1.
	 * @param automatonLabel2 nome do autômato 2.
	 */
	public void differenceFiniteAutomata(String automatonLabel1, String automatonLabel2) {
		this.mainController.differenceFiniteAutomata(automatonLabel1, automatonLabel2);
	}
