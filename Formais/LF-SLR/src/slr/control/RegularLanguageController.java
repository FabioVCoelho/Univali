...
public class RegularLanguageController {
	...
	/**
	 * Unir dois autômatos finitos.
	 * @param automaton1 autômato 1.
	 * @param automaton2 autômato 2.
	 * @return lista de autômatos correspondentes à união.
	 */
	public List<String> unionFiniteAutomaton(FiniteAutomaton automaton1, FiniteAutomaton automaton2) {
		List<String> automataLabels = new ArrayList<String>();

		for(FiniteAutomaton fa : automaton1.unionView(automaton2)) {
			this.finiteAutomata.put(fa.getName(), fa);
			automataLabels.add(fa.getName());
		}
	...
	/**
	 * Diferença entre dois autômatos finitos.
	 * @param automaton1 autômato 1.
	 * @param automaton2 autômato 2.
	 * @return lista de autômatos correspondentes à diferença.
	 */
	public List<String> differenceFiniteAutomaton(FiniteAutomaton automaton1, FiniteAutomaton automaton2) {
		List<String> automataLabels = new ArrayList<String>();

		for(FiniteAutomaton fa : automaton1.difference(automaton2)) {
			this.finiteAutomata.put(fa.getName(), fa);
			automataLabels.add(fa.getName());
		}
